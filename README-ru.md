# TradeLink Studio
  ...
  **TradeLink Studio** — настольное приложение для вычисления и анализа индексов влияния в ориентированных взвешенных графах. Поддерживает импорт данных из `.xlsx` и `.csv`, интерактивное редактирование матрицы и экспорты результатов в формате `.xlsx`.
  ...
  **Контакты для связи:**  admishchenko@edu.hse.ru
  ...
  [Скачать актуальную версию TradeLink Studio](https://github.com/AleksxGH/TradeLinkStudio/releases/latest)

  [Англоязычная версия README](README.md)  
